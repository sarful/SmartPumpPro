  ...
  return (
    <section className="grid gap-4 xl:grid-cols-3">
      <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Provision</div>
        <div className="mt-1 text-lg font-semibold text-slate-950">Create Admin</div>
        <input
        ...
        <input
          type="password"
          className="mt-3 w-full rounded-2xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900"
        ...
        <button
          ...
          className="mt-4 w-full rounded-2xl bg-blue-600 px-4 py-3 text-sm font-semibold text-white hover:bg-blue-500"
        >
          Create Admin
        </button>
      </div>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Provision</div>
        <div className="mt-1 text-lg font-semibold text-slate-950">Create User</div>
        <input
          className="mt-4 w-full rounded-2xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900"
          placeholder="username"
        ...
        <button
          ...
          className="mt-4 w-full rounded-2xl bg-blue-600 px-4 py-3 text-sm font-semibold text-white hover:bg-blue-500 disabled:opacity-60"
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Linking</div>
        <div className="mt-1 text-lg font-semibold text-slate-950">RFID Card Registration</div>
        <div className="mt-4 grid gap-3">
          ...
          <input
            className="w-full rounded-2xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 uppercase"
        ...
        <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center">
          <button
            ...
            className="rounded-2xl bg-indigo-600 px-4 py-3 text-sm font-semibold text-white hover:bg-indigo-500 disabled:opacity-60"
          >
          ...
          <button
            ...
            className="rounded-2xl border border-slate-300 px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 disabled:opacity-60"
          >
            Clear
          </button>
