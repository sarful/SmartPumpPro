  ...
  try {
    ...
    if (action === "recharge") {
      ...
      await logEvent({
        ...
        meta: { source: "mobile_master_recharge" },
      });
    ...
    if (action === "set") {
      ...
      await logEvent({
        ...
        meta: { source: "mobile_master_set_balance", before, after: user.availableMinutes },
      });
    ...
    console.error("mobile master users minutes error", error);
